 ...
 <div class="table-container">
    ...
    <div class="form-container">
        ...
        <form method="POST" @submit.prevent="demandValidation">
            ...
            <p v-if="demand.user">Personne concernée par l'échange : {{ demand.user.pseudo }}</p>
        ...
        this.$apollo
            ...
            this.$apollo
                ...
                variables: {
                    ...
                    walletAmount: this.user.walletAmount + this.demand.amount,
                    }
                })
                .then((data) => {
                    this.$apollo
                    ...
                    mutation: gql`
                        ...
                        `,
                    variables: {
                        id: this.demand.user.id,
                        walletAmount: this.demand.user.walletAmount - this.demand.amount
                        }
                    })
                    .then((data) => {
                    event.target.reset()
