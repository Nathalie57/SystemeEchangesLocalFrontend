  ...
  <client-only>
    <div class="right-side-bar-container">
      ...
      <ul class="right-side-bar">
        ...
        <li v-for="offer in offers"><router-link tag="a" to="/" exact><img src="../images/orange-arrow-right.svg" class="arrow">{{ offer.offer_title }}</router-link></li>
        <router-link tag="a" to="/voir-les-offres" exact><button  class="see-more-button">Voir plus d'offres</button></router-link></li>
      </ul>
      
      <ul class="right-side-bar">
        <li v-for="demand in demands"><router-link tag="a" to="/" exact><img src="../images/orange-arrow-right.svg" class="arrow">{{ demand.demand_title}}</router-link></li>
